...
public class GymJianJieFragment extends BaseFragment {
    ...
    protected void lazyLoad() {
        ...
        mPostTypes.put(CommonApi.homeImple.selectBannerList(2,"简介",gymItem.getGymId()+""),"selectBannerList");
    }
    ...
    protected void initViews(ViewHolder holder, View root) {
        ...
        setLinsener();
        if(gymItem!=null){
            businessDate.setText(DateUtil.isEmpty(gymItem.getBusinessDate())?"营业时间:":"营业时间:"+gymItem.getBusinessDate());
            businessTime.setText(DateUtil.isEmpty(gymItem.getBusinessTime())?"":gymItem.getBusinessTime());
            remark.setText(DateUtil.isEmpty(gymItem.getRemark())?"":gymItem.getRemark());
            item_vc.setText("浏览量 "+gymItem.getVisitNum());
            favorNum.setText(gymItem.getFavorNum()+" 万");
            focusNum.setText("粉丝 "+gymItem.getFocusNum()+"万");
            ...
            Glide.with(mContext)
                    .load(Constant.IMAGE_URL+gymItem.getPhoto())
                    .apply(options)
                    .into(item_image);
        }
    }
